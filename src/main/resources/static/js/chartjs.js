...
function ChartRefresh(newData){
    if (newData == undefined){
    var newData = {
                tem:[23,23,24,24,24,24,25,26,28,30,26,24],
                hum:[17,17,18,19,21,20,19,18,18,17,17,17],
                labe:["05:34:33","05:34:29","05:34:25","05:34:20",
                "05:34:16","05:34:12","05:34:08","05:34:04","05:34:00",
                "05:33:59","05:33:58","05:33:53"]
    };
    }
    LineChart(newData.tem, newData.hum, newData.labe);
    BarChart(newData.tem, newData.hum, newData.labe);
    RadarChart(newData.tem, newData.hum, newData.labe);
}

function LineChart(tem, hum, timeLabe) {
...
function BarChart(tem, hum, timeLabe) {
...
function RadarChart(tem, hum, timeLabe) {
  var ctx, data, myBarChart, option_bars;
  Chart.defaults.global.responsive = true;
